  ...
  <section class="content">
    ...
    {{ Form::open(array('url' => 'spesialites' ,'id' => 'create' , 'class' => 'form-horizontal')) }}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {{ Form::text('year', '', array('class' => 'form-control' , 'placeholder' => '1')) }}
          </div>
        </div>
        ...
        <div class="form-group">
            {{ Form::label('spesialite', 'Spesialité' , array('class' => 'col-sm-2 control-label')) }}
            <div class="col-sm-10">
                <select name="spesialite" id="spesialite" class="form-control">
        ...
        <div class="form-group">
            {{ Form::label('departement', 'Departement' , array('class' => 'col-sm-2 control-label')) }}
            <div class="col-sm-10">
                {{ Form::select('departement', $departements, null, ['placeholder' => 'Departements ...' , 'class' => 'form-control']) }}
            </div>
        </div>
  ...
  $("#domain").change(function(){
    ...
    $.post("{{ route('getfiliers') }}",
            ...
            function(data, status){
              ...
              if (data != '') {
                  $("#filiers").html('<option value="0">Tranc commain</option>');
                  $("#filiers").append(data);
                  $("#spesialite").html('<option value="0">Tranc commain</option>');
              }
            });
  });
